...
const Footer = () => {
  return (
<>
<footer class="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 pt-20 pb-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
